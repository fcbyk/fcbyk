...
<template>
    <div class="bg-[var(--input-bg)] p-2 pl-0 min-h-[50px]"> 
        <!-- 输入框容器 --> 
        <div
            class="flex items-end transition-all duration-200">

            <textarea ref="textareaRef" v-model="inputValue"
                class="flex-1 px-2 py-[6px] rounded-[5px] resize-none bg-[var(--my-message-bg)] focus:outline-none text-[var(--input-text)] placeholder-[var(--text-placeholder)] overflow-y-auto no-scrollbar"
